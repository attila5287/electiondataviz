  ...
  function drawMap() {// create map for the 1st time
    ...
    legend.onAdd = function ( map ) {
      ...
      for ( var i = 0; i < partyNames.length; i++ ) {
        div.innerHTML +=
          '<h5 class="text-light text-balo text-center rnd-2xl px-2 py-1 mb-2" style="background:' + colors[ i ] +
          ';">' +
          partyNames[ i ] +
          '</h5> ';
      }
...
var info = L.control();
    ...
    info.update = function ( props ) {
      ...
      this._div.innerHTML = '<a class="btn bg-theme text-onerem text-balo text-center shadow-after text-light rnd-2xl py-2 px-3  mb-2 ">US Presidential </a>' + ( props ?
        '<br><a class="btn btn-lg shadow-after text-balo text-onerem text-nowrap text-center text-light py-1 px-3 rnd-2xl mt-2 ' +
        btnColors[ props.winner ] +
        '">' +
        props.name +
